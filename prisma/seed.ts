...
const userData: Prisma.UserCreateInput = {
  ...
  pets: {
    create: [
      ...
      {
        name: 'Theodoro',
        ownerName: 'Maria Teresa',
        imageUrl:
          'https://images.unsplash.com/photo-1547482354-89d4259dbc4b?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8eW9ya3NoaXJlJTIwdGVycmllcnxlbnwwfHwwfHx8MA%3D%3D',
        age: 6,
        notes: 'Não gosta de garrafões de água.',
      },
    ],
  },
};
